package org.shell.mmo.sample.message.proto {
	...
	public dynamic final class CatanMasterResource extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ID:FieldDescriptor_TYPE_FIXED64 = new FieldDescriptor_TYPE_FIXED64("org.shell.mmo.sample.message.proto.CatanMasterResource.id", "id", (1 << 3) | com.netease.protobuf.WireType.FIXED_64_BIT);
		 ...
		 *  @private
		 */
		public static const RESOURCE:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("org.shell.mmo.sample.message.proto.CatanMasterResource.resource", "resource", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.mmo.sample.message.proto.CatanResource; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: CatanMasterResource.id cannot be set twice.');
					}
					++id$count;
