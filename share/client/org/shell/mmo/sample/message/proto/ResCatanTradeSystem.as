package org.shell.mmo.sample.message.proto {
	...
	public dynamic final class ResCatanTradeSystem extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ERROR:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("org.shell.mmo.sample.message.proto.ResCatanTradeSystem.error", "error", (1 << 3) | com.netease.protobuf.WireType.VARINT, org.shell.mmo.sample.message.proto.Error);
		 ...
		 *  @private
		 */
		public static const OFFER:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("org.shell.mmo.sample.message.proto.ResCatanTradeSystem.offer", "offer", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.mmo.sample.message.proto.CatanResource; });
		 ...
		 *  @private
		 */
		public static const WANT:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("org.shell.mmo.sample.message.proto.ResCatanTradeSystem.want", "want", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.mmo.sample.message.proto.CatanResource; });
		 ...
		 *  @private
		 */
		public static const ID:FieldDescriptor_TYPE_FIXED64 = new FieldDescriptor_TYPE_FIXED64("org.shell.mmo.sample.message.proto.ResCatanTradeSystem.id", "id", (4 << 3) | com.netease.protobuf.WireType.FIXED_64_BIT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (error$count != 0) {
						throw new flash.errors.IOError('Bad data format: ResCatanTradeSystem.error cannot be set twice.');
					}
					++error$count;
				...
				case 4:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ResCatanTradeSystem.id cannot be set twice.');
					}
					++id$count;
