package org.shell.mmo.sample.message.proto {
	...
	public dynamic final class ResCatanBuildCountry extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ERROR:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("org.shell.mmo.sample.message.proto.ResCatanBuildCountry.error", "error", (1 << 3) | com.netease.protobuf.WireType.VARINT, org.shell.mmo.sample.message.proto.Error);
		 ...
		 *  @private
		 */
		public static const ID:FieldDescriptor_TYPE_FIXED64 = new FieldDescriptor_TYPE_FIXED64("org.shell.mmo.sample.message.proto.ResCatanBuildCountry.id", "id", (2 << 3) | com.netease.protobuf.WireType.FIXED_64_BIT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (error$count != 0) {
						throw new flash.errors.IOError('Bad data format: ResCatanBuildCountry.error cannot be set twice.');
					}
					++error$count;
				...
				case 2:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ResCatanBuildCountry.id cannot be set twice.');
					}
					++id$count;
