package org.shell.mmo.sample.message.proto {
	...
	public dynamic final class ResRoleCreateRole extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ERROR:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("org.shell.mmo.sample.message.proto.ResRoleCreateRole.error", "error", (1 << 3) | com.netease.protobuf.WireType.VARINT, org.shell.mmo.sample.message.proto.Error);
		 ...
		 *  @private
		 */
		public static const LEADERROLE:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("org.shell.mmo.sample.message.proto.ResRoleCreateRole.leaderRole", "leaderRole", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.mmo.sample.message.proto.LeaderRole; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (error$count != 0) {
						throw new flash.errors.IOError('Bad data format: ResRoleCreateRole.error cannot be set twice.');
					}
					++error$count;
				...
				case 2:
					if (leaderRole$count != 0) {
						throw new flash.errors.IOError('Bad data format: ResRoleCreateRole.leaderRole cannot be set twice.');
					}
					++leaderRole$count;
