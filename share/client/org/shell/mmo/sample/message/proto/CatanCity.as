package org.shell.mmo.sample.message.proto {
	...
	public dynamic final class CatanCity extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const POINT:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("org.shell.mmo.sample.message.proto.CatanCity.point", "point", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.mmo.sample.message.proto.Position; });
		 ...
		 *  @private
		 */
		public static const ID:FieldDescriptor_TYPE_FIXED64 = new FieldDescriptor_TYPE_FIXED64("org.shell.mmo.sample.message.proto.CatanCity.id", "id", (2 << 3) | com.netease.protobuf.WireType.FIXED_64_BIT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (point$count != 0) {
						throw new flash.errors.IOError('Bad data format: CatanCity.point cannot be set twice.');
					}
					++point$count;
				...
				case 2:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: CatanCity.id cannot be set twice.');
					}
					++id$count;
