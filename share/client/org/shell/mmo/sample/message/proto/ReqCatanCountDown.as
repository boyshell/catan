package org.shell.mmo.sample.message.proto {
	...
	public dynamic final class ReqCatanCountDown extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ID:FieldDescriptor_TYPE_FIXED64 = new FieldDescriptor_TYPE_FIXED64("org.shell.mmo.sample.message.proto.ReqCatanCountDown.id", "id", (1 << 3) | com.netease.protobuf.WireType.FIXED_64_BIT);
		 ...
		 *  @private
		 */
		public static const REMAIN:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("org.shell.mmo.sample.message.proto.ReqCatanCountDown.remain", "remain", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ReqCatanCountDown.id cannot be set twice.');
					}
					++id$count;
				...
				case 2:
					if (remain$count != 0) {
						throw new flash.errors.IOError('Bad data format: ReqCatanCountDown.remain cannot be set twice.');
					}
					++remain$count;
